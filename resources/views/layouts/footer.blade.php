<footer class="nebula-bg relative overflow-hidden text-neutral-700 dark:text-neutral-300">
    <div class="container-app relative py-16">
        <div class="grid gap-12 md:grid-cols-3">
            <x-reveal>
                <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-accent-50 dark:bg-white/10 text-xl text-accent-600 dark:text-accent-400">
                ...
                <div class="mt-4 flex gap-4 text-neutral-500 dark:text-neutral-500">
                    ...
                    <a href="https://www.linkedin.com/in/mohamed-khalil-boutar-6b8654157/" target="_blank"
                        rel="noopener noreferrer" class="hover:text-accent-600 dark:hover:text-accent-400 transition-colors">
            ...
            <x-reveal :delay="100">
                ...
                <h3 class="mt-4 text-sm font-semibold uppercase tracking-wide text-neutral-900 dark:text-white">{{ __('Navigation') }}</h3>
                <ul class="mt-4 space-y-2 text-sm">
                    @foreach ([['url' => route('home'), 'label' => __('About')], ['url' => route('projects'), 'label' => __('Projects')], ['url' => route('resume'), 'label' => __('Resume')], ['url' => route('service'), 'label' => __('Services')], ['url' => route('contact'), 'label' => __('Contact')]] as $link)
                        <li>
                            <a href="{{ $link['url'] }}"
                                class="group inline-flex items-center gap-1.5 text-neutral-600 dark:text-neutral-400 hover:text-accent-600 dark:hover:text-accent-400 transition-colors">
            ...
            <x-reveal :delay="200">
                ...
                <h3 class="mt-4 text-sm font-semibold uppercase tracking-wide text-neutral-900 dark:text-white">{{ __('Get in touch') }}</h3>
                <ul class="mt-4 space-y-3 text-sm text-neutral-600 dark:text-neutral-400">
                    <li class="flex items-center gap-3">
                        <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-accent-50 dark:bg-white/10 text-accent-600 dark:text-accent-400">
